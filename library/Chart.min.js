        ...
        1: [function (t, e, a) {
            ...
            e.exports = function (t) {
                ...
                o.requestAnimFrame = function () {
                    ...
                    return i ? i(e instanceof CanvasGradient ? t.defaults.global.defaultColor : e) : (console.error("Color.library not found!"), e)
            ...
            i = "function" == typeof i ? i : window.moment, e.exports = function (t) {
                var e = t.helpers, a = {
                    ...
                    initialize: function () {
                        if (!i) throw new Error("Chart.library - Moment.library could not be found! You must include it before Chart.library to use the time scale. Download at https://momentjs.com");
                        ...
                        var e = this;
                        return "string" == typeof e.options.time.parser ? i(t, e.options.time.parser) : "function" == typeof e.options.time.parser ? e.options.time.parser(t) : "function" == typeof t.getMonth || "number" == typeof t ? i(t) : t.isValid && t.isValid() ? t : "string" != typeof e.options.time.format && e.options.time.format.call ? (console.warn("options.time.format is deprecated and replaced by options.time.parser. See http://nnnick.github.io/Chart.library/docs-v2/#scales-time-scale"), e.options.time.format(t)) : i(t, e.options.time.format)
                    }
                });
